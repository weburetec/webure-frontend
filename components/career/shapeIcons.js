...
const ShapeIcons = () => {
  return (
    <div className="container">
      ...
      <div className="flex px-2 gap-5 md:px-6 mt-4 bg16">
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">              
          <image src="https://growzilla.co/images/icons/empathy.svg" alt="Webure Technologies" loading="lazy" />
          <h5 className="text-3xl font-Lexend text-center text-gray-600">Empathy</h5>
          <p className="text-base font-Lexend text-center">We let you connect with a community that truly cares and with building relationships, comes empathy. </p>              
        </div>
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">
          <image src="https://growzilla.co/images/icons/manner%20(Traced).svg" alt="Webure Technologies Bangalore" loading="lazy" />
          <h5 className="text-3xl font-Roboto text-center text-gray-600 font-bold">Courtesy</h5>
          <p className="text-base font-Lexend text-center">We have built a safe space for you to interact, share and learn with others, this is what defines us. </p>          
        </div>
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">
          <image src="https://growzilla.co/images/icons/success%20(Traced).svg" alt="Webure Technologies" loading="lazy" />
          <h5 className="text-3xl font-Roboto text-center text-gray-600 font-bold">Thriving</h5>
          <p className="text-base font-Lexend text-center">Being a part of the community that is truly engaging gives you a sense of belonging and wishfulness. </p>          
        </div>
      </div>
      <div className="flex px-2 gap-5 md:px-6 mt-4">
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">              
          <image src="https://growzilla.co/images/icons/Group%20328.svg" alt="Webure Technologies Bangalore" loading="lazy" />
          <h5 className="text-3xl font-Roboto text-center text-gray-600 font-bold">Craftsmanship</h5>
          <p className="text-base font-Lexend text-center">To best define craftsmanship, we believe in patience, purpose and beauty. We thrive to live by the words.  </p>              
        </div>
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">
          <image src="https://growzilla.co/images/icons/Group%20327.svg" alt="Webure Technologies Bangalore" loading="lazy" />
          <h5 className="text-3xl font-Roboto text-center text-gray-600 font-bold">Integrity</h5>
          <p className="text-base font-Lexend text-center">Our community is a reflection of our thoughts of trust, respect, and honesty. We believe in standing strong together. </p>          
        </div>
        <div className="w-1/3 p-8 border-solid border-2 border-gray-200 rounded-md">
          <image src="https://growzilla.co/images/icons/Group%20326.svg" alt="Webure Technologies" loading="lazy" />
          <h5 className="text-3xl font-Roboto text-center text-gray-600 font-bold">Solidarity</h5>
          <p className="text-base font-Lexend text-center">Our community is defined by the highlighted value of unity which is seen in the social bonds that they own. </p>          
        </div>
      </div>
      <br />
      <br />
