          ...
          <div>
            <div className="flex">
              <div className="col-md-4">
                <div>
                  <img alt="" srcset="https://www.classicinformatics.com/hubfs/quality%20assurance%202.png" src="https://www.classicinformatics.com/hs-fs/hubfs/service-icon2.png?width=87&amp;name=service-icon2.png" width="56" height="56" decoding="async" data-nimg="future" loading="lazy" />
                </div>
              </div>
              <div className="col-md-4">
                <div className="ind_item_1 border-purple-900 hover:border-purple-800">
                  <img alt="" srcset="https://www.classicinformatics.com/hs-fs/hubfs/service-icon2.png?width=87&amp;name=service-icon2.png" src="https://www.classicinformatics.com/hs-fs/hubfs/service-icon2.png?width=87&amp;name=service-icon2.png" width="56" height="56" decoding="async" data-nimg="future" loading="lazy" />
