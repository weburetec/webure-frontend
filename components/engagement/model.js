                                ...
                                <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                      <span class="truncate font-medium">Best-suited for frozen and highly defined requirements</span>
                                    </div>
                                  </div>
                                </li>
                                <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                      <span class="truncate font-medium">Client pays a fixed price</span>
                                    </div>
                                  </div>
                                </li>
                                <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                      <span class="truncate font-medium">Minimum exposure to risk</span>
                                    </div>
                                  </div>
                                </li> 
                                <li class="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                                  <div class="flex w-0 flex-1 items-center">
                                    ...
                                    <div class="ml-4 flex min-w-0 flex-1 gap-2">
                                      <span class="truncate font-medium">Highly transparent development process</span>
                                    </div>
                                  </div>
                                </li>    
                              </ul>    
