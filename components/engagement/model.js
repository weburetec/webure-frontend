              ...
              <div className='justify-center items-center content-center'>
                <div className='items-center justify-center py-6 md:justify-center md:space-x-10'>
                  <div className="flex flex-wrap justify-center -mx-4">
                    ...
                    <div className="w-full md:w-1/2 xl:w-1/2 px-1">
                      <img className="px-5" alt="Webure Digital Transformation" srcset="https://res.cloudinary.com/weburetec/image/upload/v1690824620/bsjen2tk2mzyjhidhbyd.png" src="https://res.cloudinary.com/weburetec/image/upload/v1690824620/bsjen2tk2mzyjhidhbyd.png" decoding="async" data-nimg="future" loading="lazy" />
                    </div>
                  </div>
                </div>
              </div>
