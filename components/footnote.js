                ...
                <div className="left_footer1">
                  ...
                  <div className="f_left_new2">
                    ...
                    <div className="socialblock">
                      <a
                        href="https://www.facebook.com/W3Nuts/"
                ...
                <div className="right_footer1">
                  ...
                  <div className="flex -mt-2 pt-8 gap-2">
                    <div className="w-1/3 border-solid border-2 border-[#777777] p-2">
                      ...
                      <p className="text-[#777777] text-base font-Lexend">Embassy Techvillage, HD-073 We Work Bellandur Bangalore Karnataka</p>
                    </div>
                    <div className="w-1/3 border-solid border-2 border-[#777777] p-2">
                    <p className="text-lg md:text-xl text-white font-normal font-Lexend">USA</p>
                      ...
                      <p className=" text-[#777777] text-base md:text-md font-Lexend">1 World Trade Centre, 285 Fulton Street Suite 8500 New York City, New York</p>
                    </div>                    
                    <div className="w-1/3 border-solid border-2 border-[#777777] p-2">
                    <p className="text-lg md:text-xl text-white font-normal font-Lexend">United Kingdom</p>
                      ...
                      <p className="text-[#777777] text-base md:text-md font-Lexend">Level 30 Leadenhall Building, 122 Leadenhall Street, London, EC3V 4AB, UK</p>
                    </div>
                    <div className="w-1/3 border-solid border-2 border-[#777777] p-2">
                    <p className="text-lg md:text-xl text-white font-normal font-Lexend">Australia</p>
                      ...
                      <p className="text-[#777777] text-base md:text-md font-Lexend">Level 24, Three International Towers Barangaroo Avenue, Sydney Australia</p>
                    </div>
                  </div>
                </div>
              </div>
